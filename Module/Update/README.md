...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Update.psm1. -->
...
| `Update-PowerShell` | `update-ps1` | Checks for updates to PowerShell and upgrades to the latest version if available. |
