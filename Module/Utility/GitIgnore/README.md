...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in GitIgnore.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Add-GitIgnoreContent` | `giadd` |  |
| `Get-GitIgnore` | `gitignore` | Generate .gitignore content for specified technologies using gitignore.io API. |
| `Get-GitIgnoreList` | `gilist` | Get a list of all available gitignore templates from gitignore.io. |
| `Get-GitIgnoreTypes` | `gitypes` | Get a list of all available gitignore types/templates with pagination. |
| `New-GitIgnoreFile` | `ginew` | Create a new .gitignore file with specified technologies in the current directory. |
| `Test-GitIgnoreService` | `gitest` | Test connectivity to the gitignore.io API service. |
