...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Terragrunt.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-TerragruntCacheDir` |  | Gets the Terragrunt cache directory. |
| `Get-TerragruntConfigPath` |  | Gets the path to the terragrunt.hcl configuration file. |
| `Get-TerragruntWorkingDir` |  | Gets the Terragrunt working directory. |
| `Invoke-Terragrunt` | `tg` | Base Terragrunt command wrapper. |
| `Invoke-TerragruntApply` | `tga` | Apply Terragrunt configuration. |
| `Invoke-TerragruntApplyAll` | `tgaa` | Apply all Terragrunt modules. |
| `Invoke-TerragruntDestroy` | `tgd` | Destroy Terragrunt-managed infrastructure. |
| `Invoke-TerragruntDestroyAll` | `tgda` | Destroy all Terragrunt-managed infrastructure. |
| `Invoke-TerragruntFormat` | `tgf`, `tgfmt` | Format Terragrunt HCL files. |
| `Invoke-TerragruntFormatHCL` |  | Format HCL files with Terragrunt. |
| `Invoke-TerragruntGet` | `tgget` | Download and update Terragrunt modules. |
| `Invoke-TerragruntGraphDependencies` | `tggd` | Generate dependency graph. |
| `Invoke-TerragruntInit` | `tgi` | Initialize Terragrunt working directory. |
| `Invoke-TerragruntInitFromModule` | `tgifm` | Initialize Terragrunt from a remote module. |
| `Invoke-TerragruntOutputAll` | `tgo` | Get outputs from all Terragrunt modules. |
| `Invoke-TerragruntOutputModuleGroups` | `tgomg` | Get outputs organized by module groups. |
| `Invoke-TerragruntPlan` | `tgp` | Create Terragrunt execution plan. |
| `Invoke-TerragruntPlanAll` | `tgpa` | Create execution plan for all Terragrunt modules. |
| `Invoke-TerragruntProviders` | `tgpv` | Show Terragrunt provider information. |
| `Invoke-TerragruntRefresh` | `tgr` | Refresh Terragrunt state. |
| `Invoke-TerragruntRefreshAll` | `tgra` | Refresh all Terragrunt module states. |
| `Invoke-TerragruntRenderJSON` | `tgrj` | Render Terragrunt configuration as JSON. |
| `Invoke-TerragruntShow` | `tgsh` | Show Terragrunt state or plan. |
| `Invoke-TerragruntStateList` | `tgsl` | List resources in Terragrunt state. |
| `Invoke-TerragruntStateMv` | `tgsm` | Move resource in Terragrunt state. |
| `Invoke-TerragruntStateRm` | `tgsr` | Remove resource from Terragrunt state. |
| `Invoke-TerragruntStateShow` | `tgss` | Show specific resource in Terragrunt state. |
| `Invoke-TerragruntValidate` | `tgv` | Validate Terragrunt configuration. |
| `Invoke-TerragruntValidateAll` | `tgva` | Validate all Terragrunt configurations. |
| `Invoke-TerragruntValidateInputs` | `tgvi` | Validate Terragrunt input variables. |
| `Invoke-TerragruntVersion` | `tgver` | Show Terragrunt version. |
