...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in UV.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-UVProjectInfo` |  | Gets UV project information. |
| `Get-UVVirtualEnvPath` |  | Gets the path to the UV virtual environment. |
| `Invoke-UVAdd` | `uva` | Add dependencies to UV project. |
| `Invoke-UVBuild` | `uvb` | Build UV project. |
| `Invoke-UVExport` | `uvexp` | Export UV dependencies to requirements format. |
| `Invoke-UVInit` | `uvi` | Initialize new UV project. |
| `Invoke-UVLock` | `uvl` | Create or update UV lock file. |
| `Invoke-UVLockRefresh` | `uvlr` | Refresh UV lock file. |
| `Invoke-UVLockUpgrade` | `uvlu` | Upgrade UV lock file. |
| `Invoke-UVPip` | `uvp` | Use pip functionality through UV. |
| `Invoke-UVPublish` | `uvpub` | Publish UV project. |
| `Invoke-UVPython` | `uvpy` | Manage Python versions with UV. |
| `Invoke-UVRemove` | `uvrm` | Remove dependencies from UV project. |
| `Invoke-UVRun` | `uvr` | Run command in UV environment. |
| `Invoke-UVSelfUpdate` | `uvup` | Update UV itself. |
| `Invoke-UVSync` | `uvs` | Synchronize UV project dependencies. |
| `Invoke-UVSyncRefresh` | `uvsr` | Synchronize UV project with refresh. |
| `Invoke-UVSyncUpgrade` | `uvsu` | Synchronize UV project with upgrade. |
| `Invoke-UVTool` | `uvt` | Manage UV tools. |
| `Invoke-UVToolInstall` | `uvti` | Install tool with UV. |
| `Invoke-UVToolList` | `uvtl` | List installed UV tools. |
| `Invoke-UVToolRun` | `uvtr`, `uvx` | Run tool with UV. |
| `Invoke-UVToolUninstall` | `uvtu` | Uninstall tool with UV. |
| `Invoke-UVToolUpgrade` | `uvtup` | Upgrade UV tools. |
| `Invoke-UVVenv` | `uvv` | Create virtual environment with UV. |
| `Invoke-UVVersion` | `uvver` | Show UV version. |
