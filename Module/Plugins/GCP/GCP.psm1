...
#---------------------------------------------------------------------------------------------------
# Only load functions if gcloud is installed
#---------------------------------------------------------------------------------------------------
if (Test-GCloudInstalled) {
    ...
    Write-Warning "Google Cloud SDK (gcloud) is not installed or not available in PATH. Please install it from: https://cloud.google.com/sdk/docs/install"
}
