...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Flutter.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-FlutterDevices` | `fldvcs` | List available devices for Flutter development. |
| `Get-FlutterPubPackages` | `flget` | Get package dependencies for Flutter project. |
| `Invoke-Flutter` | `flu` | Executes flutter command with specified arguments. |
| `Invoke-FlutterAttach` | `flattach` | Attach to a running application. |
| `Invoke-FlutterBuild` | `flb` | Build a Flutter application. |
| `Invoke-FlutterChannel` | `flchnl` | Manage Flutter SDK channels. |
| `Invoke-FlutterClean` | `flc` | Clean build files and caches. |
| `Invoke-FlutterDoctor` | `fldoc` | Check Flutter installation and dependencies. |
| `Invoke-FlutterPub` | `flpub` | Execute Flutter pub commands. |
| `Start-FlutterApp` | `flr` | Run a Flutter application. |
| `Start-FlutterAppDebug` | `flrd` | Run Flutter application in debug mode. |
| `Start-FlutterAppProfile` | `flrp` | Run Flutter application in profile mode. |
| `Start-FlutterAppRelease` | `flrr` | Run Flutter application in release mode. |
| `Update-Flutter` | `flupgrd` | Upgrade Flutter SDK. |
