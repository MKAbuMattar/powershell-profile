...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in NPM.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Invoke-NpmAudit` | `npma` | Run npm security audit. |
| `Invoke-NpmAuditFix` | `npmaf` | Fix npm security vulnerabilities. |
| `Invoke-NpmCache` | `npmc` | Manage npm cache. |
| `Invoke-NpmConfigGet` | `npmcg` | Get npm configuration value. |
| `Invoke-NpmConfigList` | `npmcl` | List npm configuration. |
| `Invoke-NpmConfigSet` | `npmcs` | Set npm configuration value. |
| `Invoke-NpmDoctor` | `npmdoc` | Run npm doctor diagnostics. |
| `Invoke-NpmExecute` | `npmE` | Execute commands from node_modules folder. |
| `Invoke-NpmInfo` | `npmi` | Get package information. |
| `Invoke-NpmInit` | `npminit` | Initialize npm package. |
| `Invoke-NpmInstall` |  | Install npm packages. |
| `Invoke-NpmInstallDev` | `npmD` | Install and save packages to dev-dependencies. |
| `Invoke-NpmInstallForce` | `npmF` | Force npm to fetch remote resources. |
| `Invoke-NpmInstallGlobal` | `npmg` | Install npm packages globally. |
| `Invoke-NpmInstallSave` | `npmS` | Install and save packages to dependencies. |
| `Invoke-NpmLink` | `npmln` | Link npm package. |
| `Invoke-NpmList` | `npmL` | List installed packages. |
| `Invoke-NpmListTopLevel` | `npmL0` | List top-level installed packages. |
| `Invoke-NpmLogin` | `npmlogin` | Login to npm registry. |
| `Invoke-NpmLogout` | `npmlogout` | Logout from npm registry. |
| `Invoke-NpmOutdated` | `npmO` | Check which npm modules are outdated. |
| `Invoke-NpmPing` | `npmping` | Ping npm registry. |
| `Invoke-NpmPublish` | `npmP` | Publish npm package. |
| `Invoke-NpmRun` | `npmR` | Run npm scripts. |
| `Invoke-NpmRunBuild` | `npmrb` | Run npm build script. |
| `Invoke-NpmRunDev` | `npmrd` | Run npm development script. |
| `Invoke-NpmRunScript` | `npmrs` | Run custom npm script. |
| `Invoke-NpmSearch` | `npmSe` | Search for npm packages. |
| `Invoke-NpmStart` | `npmst` | Run npm start script. |
| `Invoke-NpmTest` | `npmt` | Run npm test script. |
| `Invoke-NpmUninstall` |  | Uninstall npm packages. |
| `Invoke-NpmUnlink` | `npmunln` | Unlink npm package. |
| `Invoke-NpmUpdate` | `npmU` | Update npm packages. |
| `Invoke-NpmVersion` | `npmV` | Check npm version. |
| `Invoke-NpmWhoami` | `npmwho` | Show current npm user. |
