...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Terraform.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-TerraformPromptInfo` |  | Gets Terraform workspace information for prompt display. |
| `Get-TerraformVersion` |  | Gets the Terraform version. |
| `Get-TerraformVersionPromptInfo` |  | Gets Terraform version information for prompt display. |
| `Get-TerraformWorkspace` |  | Gets the current Terraform workspace. |
| `Invoke-Terraform` | `tf` | Base Terraform command wrapper. |
| `Invoke-TerraformApply` | `tfa` | Apply Terraform configuration. |
| `Invoke-TerraformApplyAutoApprove` | `tfaa` | Apply Terraform configuration with auto-approval. |
| `Invoke-TerraformConsole` | `tfc` | Launch interactive Terraform console. |
| `Invoke-TerraformDestroy` | `tfd` | Destroy Terraform-managed infrastructure. |
| `Invoke-TerraformDestroyAutoApprove` | `tfd!` | Destroy Terraform-managed infrastructure with auto-approval. |
| `Invoke-TerraformFormat` | `tff` | Format Terraform configuration files. |
| `Invoke-TerraformFormatRecursive` | `tffr` | Format Terraform files recursively. |
| `Invoke-TerraformInit` | `tfi` | Initialize Terraform working directory. |
| `Invoke-TerraformInitReconfigure` | `tfir` | Initialize Terraform with reconfiguration. |
| `Invoke-TerraformInitUpgrade` | `tfiu` | Initialize Terraform with provider upgrade. |
| `Invoke-TerraformInitUpgradeReconfigure` | `tfiur` | Initialize Terraform with upgrade and reconfiguration. |
| `Invoke-TerraformOutput` | `tfo` | Read Terraform output values. |
| `Invoke-TerraformPlan` | `tfp` | Create Terraform execution plan. |
| `Invoke-TerraformShow` | `tfsh` | Show Terraform state or plan. |
| `Invoke-TerraformState` | `tfs` | Manage Terraform state. |
| `Invoke-TerraformTest` | `tft` | Execute Terraform test configuration. |
| `Invoke-TerraformValidate` | `tfv` | Validate Terraform configuration. |
