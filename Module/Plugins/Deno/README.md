...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Deno.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-DenoVersion` |  | Gets the installed Deno version. |
| `Invoke-Deno` | `d` | Base Deno command wrapper. |
| `Invoke-DenoBundle` | `db` | Bundle Deno project. |
| `Invoke-DenoCache` | `dca` | Cache Deno dependencies. |
| `Invoke-DenoCheck` | `dch` | Type-check Deno files. |
| `Invoke-DenoCompile` | `dc` | Compile Deno project to executable. |
| `Invoke-DenoDoc` | `ddoc` | Generate Deno documentation. |
| `Invoke-DenoEval` | `de` | Evaluate Deno code. |
| `Invoke-DenoFormat` | `dfmt` | Format Deno code. |
| `Invoke-DenoHelp` | `dh` | Show Deno help. |
| `Invoke-DenoInfo` | `dinf` | Show Deno module information. |
| `Invoke-DenoInit` | `dinit` | Initialize Deno project. |
| `Invoke-DenoInstall` | `di` | Install Deno script. |
| `Invoke-DenoLint` | `dli` | Lint Deno code. |
| `Invoke-DenoPublish` | `dpub` | Publish Deno module. |
| `Invoke-DenoRepl` | `dr` | Start Deno REPL. |
| `Invoke-DenoRun` | `drn` | Run Deno script. |
| `Invoke-DenoRunAll` | `drA` | Run Deno script with all permissions. |
| `Invoke-DenoRunUnstable` | `dru` | Run Deno script with unstable APIs. |
| `Invoke-DenoRunWatch` | `drw` | Run Deno script in watch mode. |
| `Invoke-DenoServe` | `dsv` | Run Deno HTTP server. |
| `Invoke-DenoTask` | `dtask` | Run Deno task. |
| `Invoke-DenoTest` | `dts` | Run Deno tests. |
| `Invoke-DenoTypes` | `dt` | Print Deno runtime type definitions. |
| `Invoke-DenoUninstall` | `dun` | Uninstall Deno script. |
| `Invoke-DenoUpgrade` | `dup` | Upgrade Deno to latest version. |
