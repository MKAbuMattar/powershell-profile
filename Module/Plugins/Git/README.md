...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Git.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `g` |  | A PowerShell function that wraps the `git` command. |
| `ga` |  | A PowerShell function that wraps `git add`. |
| `gaa` |  | A PowerShell function that wraps `git add --all`. |
| `gam` |  | A PowerShell function that wraps `git am`. |
| `gama` |  | A PowerShell function that wraps `git am --abort`. |
| `gamc` |  | A PowerShell function that wraps `git am --continue`. |
| `gams` |  | A PowerShell function that wraps `git am --skip`. |
| `gamscp` |  | A PowerShell function that wraps `git am --show-current-patch`. |
| `gap` |  | A PowerShell function that wraps `git apply`. |
| `gapa` |  | A PowerShell function that wraps `git add --patch`. |
| `gapt` |  | A PowerShell function that wraps `git apply --3way`. |
| `gau` |  | A PowerShell function that wraps `git add --update`. |
...
| `gbr` |  | A PowerShell function that wraps `git branch --remote`. |
| `gbs` |  | A PowerShell function that wraps `git bisect`. |
| `gbsb` |  | A PowerShell function that wraps `git bisect bad`. |
| `gbsg` |  | A PowerShell function that wraps `git bisect good`. |
| `gbsn` |  | A PowerShell function that wraps `git bisect new`. |
