...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in VSCode.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Get-VSCodeExecutable` |  | Gets the available VS Code executable. |
| `Get-VSCodeExtensions` |  | List installed VS Code extensions. |
| `Get-VSCodeVersion` |  | Get VS Code version information. |
| `Invoke-VSCode` | `vsc` | Base VS Code command wrapper. |
| `Invoke-VSCodeAdd` | `vsca` | Add folder to last active VS Code window. |
| `Invoke-VSCodeDiff` | `vscd` | Open VS Code in diff mode. |
| `Invoke-VSCodeDisableExtensions` | `vscde` | Open VS Code with all extensions disabled. |
| `Invoke-VSCodeExtensionsDir` | `vsced` | Open VS Code with custom extensions directory. |
| `Invoke-VSCodeGoto` | `vscg` | Open VS Code and go to specific line and column. |
| `Invoke-VSCodeInstallExtension` | `vscie` | Install VS Code extension. |
| `Invoke-VSCodeLog` | `vscl` | Open VS Code with specific log level. |
| `Invoke-VSCodeNewWindow` | `vscn` | Open VS Code in new window. |
| `Invoke-VSCodeProfile` | `vscp` | Open VS Code with specific profile. |
| `Invoke-VSCodeReuseWindow` | `vscr` | Open VS Code in existing window. |
| `Invoke-VSCodeUninstallExtension` | `vscue` | Uninstall VS Code extension. |
| `Invoke-VSCodeUserDataDir` | `vscu` | Open VS Code with custom user data directory. |
| `Invoke-VSCodeVerbose` | `vscv` | Open VS Code with verbose logging. |
| `Invoke-VSCodeWait` | `vscw` | Open VS Code and wait for files to be closed. |
