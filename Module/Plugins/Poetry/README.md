...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Poetry.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Disable-PoetryVirtualenv` | `pvoff` | Disable virtual environment creation. |
| `Invoke-PoetryAdd` | `pad` | Add dependencies to Poetry project. |
| `Invoke-PoetryBuild` | `pbld` | Build Poetry project. |
| `Invoke-PoetryCheck` | `pch` | Check Poetry project configuration. |
| `Invoke-PoetryConfig` | `pconf` | Manage Poetry configuration. |
| `Invoke-PoetryEnvInfo` | `pvinf` | Show virtual environment information. |
| `Invoke-PoetryEnvPath` | `ppath` | Show virtual environment path. |
| `Invoke-PoetryEnvRemove` | `pvrm` | Remove virtual environment. |
| `Invoke-PoetryEnvUse` | `pvu` | Use specific Python version for environment. |
| `Invoke-PoetryExport` | `pexp` | Export dependencies to requirements format. |
| `Invoke-PoetryInit` | `pin` | Initialize a new Poetry project. |
| `Invoke-PoetryInstall` | `pinst` | Install project dependencies. |
| `Invoke-PoetryList` | `pcmd` | List available packages. |
| `Invoke-PoetryLock` | `plck` | Update the lock file. |
| `Invoke-PoetryNew` | `pnew` | Create a new Poetry project. |
| `Invoke-PoetryPublish` | `ppub` | Publish Poetry project. |
| `Invoke-PoetryRemove` | `prm` | Remove dependencies from Poetry project. |
| `Invoke-PoetryRun` | `prun` | Run commands in Poetry environment. |
| `Invoke-PoetrySelfAdd` | `psad` | Add plugins to Poetry. |
| `Invoke-PoetrySelfShowPlugins` | `pplug` | Show installed Poetry plugins. |
| `Invoke-PoetrySelfUpdate` | `psup` | Update Poetry itself. |
| `Invoke-PoetryShell` | `psh` | Activate Poetry virtual environment shell. |
| `Invoke-PoetryShow` | `pshw` | Show package information. |
| `Invoke-PoetryShowLatest` | `pslt` | Show latest package versions. |
| `Invoke-PoetryShowTree` | `ptree` | Show dependency tree. |
| `Invoke-PoetrySync` | `psync` | Synchronize environment with lock file. |
| `Invoke-PoetryUpdate` | `pup` | Update project dependencies. |
