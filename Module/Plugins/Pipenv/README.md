...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Pipenv.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Disable-PipenvAutoShell` |  | Disables automatic pipenv shell activation. |
| `Enable-PipenvAutoShell` |  | Enables automatic pipenv shell activation. |
| `Invoke-PipenvCheck` | `pch` | Check for security vulnerabilities. |
| `Invoke-PipenvClean` | `pcl` | Clean unused dependencies. |
| `Invoke-PipenvGraph` | `pgr` | Show dependency graph. |
| `Invoke-PipenvInstall` | `pi` | Install packages using pipenv. |
| `Invoke-PipenvInstallDev` | `pidev` | Install development dependencies using pipenv. |
| `Invoke-PipenvLock` | `pl` | Generate Pipfile.lock. |
| `Invoke-PipenvOpen` | `po` | Open installed package in editor. |
| `Invoke-PipenvPython` | `ppy` | Show Python interpreter path. |
| `Invoke-PipenvRequirements` | `preq` | Generate requirements.txt from Pipfile.lock. |
| `Invoke-PipenvRun` | `prun` | Run commands in pipenv environment. |
| `Invoke-PipenvScript` | `pscr` | Run predefined scripts from Pipfile. |
| `Invoke-PipenvShell` | `psh` | Activate pipenv shell. |
| `Invoke-PipenvShellToggle` |  | Toggles pipenv shell activation based on current directory. |
| `Invoke-PipenvSync` | `psy` | Install dependencies from Pipfile.lock. |
| `Invoke-PipenvUninstall` | `pu` | Uninstall packages using pipenv. |
| `Invoke-PipenvUpdate` | `pupd` | Update packages using pipenv. |
| `Invoke-PipenvVenv` | `pvenv` | Show virtual environment path. |
| `Invoke-PipenvWhere` | `pwh` | Show project directory path. |
| `Test-PipenvAutoShell` |  | Tests if automatic pipenv shell activation is enabled. |
