...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in PIP.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Clear-PipCache` |  | Clears the pip package cache. |
| `Get-PipCacheFile` |  | Gets the pip cache file path. |
| `Invoke-PipCache` | `pipcc` | Manage pip cache. |
| `Invoke-PipCheck` | `pipck` | Verify installed packages have compatible dependencies. |
| `Invoke-PipConfig` | `pipc` | Manage pip configuration. |
| `Invoke-PipDebug` | `pipdbg` | Show pip debug information. |
| `Invoke-PipDownload` | `pipd` | Download packages without installing. |
| `Invoke-PipFreeze` |  | Show installed packages and their versions. |
| `Invoke-PipFreezeGrep` | `pipgi` | Search installed packages using grep pattern. |
| `Invoke-PipHash` | `piph` | Compute hashes of package archives. |
| `Invoke-PipHelp` |  | Show pip help information. |
| `Invoke-PipInstall` | `pipi` | Install Python packages using pip. |
| `Invoke-PipInstallEditable` | `pipie` | Install package in editable/development mode. |
| `Invoke-PipInstallGitHub` | `pipig` | Install package from GitHub repository. |
| `Invoke-PipInstallGitHubBranch` | `pipigb` | Install package from specific GitHub branch. |
| `Invoke-PipInstallGitHubPR` | `pipigp` | Install package from GitHub pull request. |
| `Invoke-PipInstallRequirements` | `pipir` | Install packages from requirements file. |
| `Invoke-PipInstallUser` | `pipiu` | Install Python packages for current user only. |
| `Invoke-PipList` | `pipl` | List installed packages. |
| `Invoke-PipListOutdated` | `piplo` | List outdated packages. |
| `Invoke-PipRequirements` | `pipreq` | Create requirements.txt file. |
| `Invoke-PipSearch` | `pipsr` | Search for packages on PyPI. |
| `Invoke-PipShow` | `pips` | Show package information. |
| `Invoke-PipUninstall` | `pipun` | Uninstall Python packages using pip. |
| `Invoke-PipUninstallAll` | `pipunall` | Uninstall all installed packages. |
| `Invoke-PipUpgrade` | `pipu` | Upgrade Python packages using pip. |
| `Invoke-PipUpgradeAll` | `pipupall` | Upgrade all installed packages. |
| `Invoke-PipWheel` | `pipw` | Build wheel archives for packages. |
| `Update-PipPackageCache` |  | Updates the pip package cache for completion. |
