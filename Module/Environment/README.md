...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Environment.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Add-PathEnvironmentVariable` | `add-path`, `set-path` | Sets the PATH environment variable. |
| `Get-EnvVar` | `get-env` | Retrieves the value of an environment variable. |
| `Get-PathEnvironmentVariable` | `get-env-path`, `get-path` | Retrieves the PATH environment variable. |
| `Invoke-ReloadPathEnvironmentVariable` | `reload-env-path`, `reload-path` | Reloads the PATH environment variable. |
| `Remove-PathEnvironmentVariable` |  | Removes a path from the PATH environment variable. |
| `Set-EnvVar` | `set-env`, `export` | Exports an environment variable. |
| `Test-GitHubConnection` | `test-github` | Reports whether github.com answers, caching the answer for the session. |
