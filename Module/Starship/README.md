...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Starship.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Invoke-StarshipTransientFunction` | `starship-transient` | Invokes the Starship module transiently to load the Starship prompt. |
