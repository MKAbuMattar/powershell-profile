...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Logging.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Invoke-ErrorHandling` | `handle-error` | Reports a failure with its underlying exception. |
| `Write-LogMessage` | `log-message` | Logs a message with a timestamp and log level. |
