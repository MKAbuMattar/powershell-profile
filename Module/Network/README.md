...
<!-- Generated by Tools/Update-Readme.ps1 from the comment-based help in Network.psm1. -->
<!-- Edit the help in the source, then re-run the tool. Changes here are overwritten. -->

| Command | Alias | Description |
| --- | --- | --- |
| `Clear-FlushDNS` | `flush-dns` | Flushes the DNS cache. |
| `Get-MyIPAddress` | `my-ip` | Retrieves the IP address of the local machine, and public IPv4 and IPv6 addresses. |
